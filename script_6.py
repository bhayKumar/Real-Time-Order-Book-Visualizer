...
# Create _app.tsx for global styles
app_component = """
// pages/_app.tsx
...
# Create _document.tsx for HTML structure
document_component = """
// pages/_document.tsx
...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <meta name="description" content="Real-Time Order Book Visualizer" />
...
print("- pages/_app.tsx")
print("- pages/_document.tsx")
print("- README.md")
print("\nREADME includes:")
print("- Installation instructions")
print("- Design decisions and trade-offs")
print("- Performance optimizations explained")
